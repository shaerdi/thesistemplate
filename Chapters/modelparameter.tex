...
Die Qualität des Fits kann anhand des von der Funktion \codeemph{leastsq} angegebenen Residuums abgeschätzt werden. Dabei zeigt sich, dass das verwendete Herschel-Bulkley Modell nicht für alle von Hilti eingesetzten Mörtel gleich gut geeignet ist. Während für die \hit{} Reihe durchwegs kleine Residuuen \todo{Zahlen} erreicht wurden, konnte der Algorithmus für Mörtel des \re{} Typs keine gute Ue;bereinstimmung gefunden werden.\\
Dies liegt daran, dass das Herschel-Bulkley Modell die Eigenschaften des Mörtels nur entweder im Bereich kleiner Scherraten \todo{Zahlen} oder im Bereich von Scherraten über x\todo{Zahlen} nachbilden kann. Passende Parameter über den ganzen Bereich gibt es nicht.
%
\subsubsection{Netze}
...
Das verwendete Netz, dargestellt in Abbildung \ref{fig:PlattenRheoGitter:subA} ist ein hexaedrisches Gitter mit einer Zelle in tangentialer Richtung und einer Diskretisierungslänge von $2^{-h} \cdot 0.2\mbox{mm}$, wobei $h\in\left\{ 0,1,2,3,4 \right\}$.
%
\begin{figure}
    \centering
