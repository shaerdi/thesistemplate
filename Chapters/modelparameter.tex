...
\centering
\subfloat[Ohne Ring]{
\includegraphics[width=.45\textwidth]{figures/platteSimOhneRingMitKoord.png}
\label{fig:platteRheoSim:subA}
}
\subfloat[Mit Ring]{
\includegraphics[width=.45\textwidth]{figures/platteSimMitRingMitKoord.png}
...
Die genaue Dokumentation des \codeemph{MaT\_Optimizer} Moduls kann in Anhang~\ref{Appendix:Python} gefunden werden.
%
...
Das verwendete Netz, dargestellt in Abbildung~\ref{fig:PlatteRheoGitter}, ist ein hexaedrisches Gitter mit einer Zelle in tangentialer Richtung und einer Diskretisierungslänge von $2^{-h} \cdot 0.2\mbox{mm}$, wobei $h\in\left\{ 0,1,2,3 \right\}$.
%
\begin{figure}[tb]
    \centering
...
\begin{figure}[tb]
    %\centering
    \subfloat[\hit{} A]{
        \includegraphics[width=\textwidth]{figures/shearViscoMaxA.png}
        \label{fig:shearViscoHY:subA}
    }\\
    \subfloat[\hit{} B]{
        \includegraphics[width=\textwidth]{figures/shearViscoMaxB.png}
        \label{fig:shearViscoHY:subB}
   } \\
    \subfloat[\re{} A]{
        \includegraphics[width=\textwidth]{figures/shearViscoReA.png}
        \label{fig:shearViscoRE:subA}
    }\\
    \subfloat[\re{} B]{
        \includegraphics[width=\textwidth]{figures/shearViscoReB.png}
...
\begin{figure}[tb]
    \subfloat[\hit{} A]{
        \includegraphics[width=\textwidth]{figures/shearLambdaMaxA.png}
        \label{fig:shearLambdaHY:subA}
    }\\
    \subfloat[\hit{} B]{
        \includegraphics[width=\textwidth]{figures/shearLambdaMaxB.png}
        \label{fig:shearLambdaHY:subB}
    }\\
    \subfloat[\re{} A]{
        \includegraphics[width=\textwidth]{figures/shearLambdaReA.png}
        \label{fig:shearLambdaRE:subA}
    }\\
    \subfloat[\re{} B]{
        \includegraphics[width=\textwidth]{figures/shearLambdaReB.png}
...
\begin{figure}[tb]
    ...
    \caption{Der simulierte Teil des Kapillarrheometers. Die Einfärbung in \subref{fig:kapRheoSim:subA} ist nach der resultierenden Geschwindigkeit, in \subref{fig:kapRheoSim:subB} kann man einen vergrösserten Ausschnitt des Netzes am Übergang zwischen Einlauf und Kapillare sehen.}
    \label{fig:kapRheoSim}
\end{figure}

Die Resultate sind in Tabelle \ref{fig:kapRheoResults} aufgeführt.
%Die Abweichungen liegen im Bereich von 0 bis 10\%, was für 
