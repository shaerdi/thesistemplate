\section{Validierung anhand des Hilti Auspressgerät}
...
%Die Teils deutlichen Unterschiede von Simulation und Messung ist einerseits auf ein nicht über d
...
\noindent\makebox[\textwidth]{%
    ...
    \multirow{2}{*}{\hit{} B}  & 2.1 & x & y & \\
                               ...
                               & 4   & x & y  &\\
    \hline\hline
    \multirow{2}{*}{\re{} A}   & 2.1 & 0.37 & 0.26 &31\%\\
                               \cline{2-5}
                              
                               & 4   & 0.48 & 0.35 &26\%\\
    \hline\hline
    \multirow{2}{*}{\re{} B}   & 2.1 & 0.41 & 0.31 &25\%\\
                               \cline{2-5}
                               & 4   & 0.51 & 0.40 &22\%\\
