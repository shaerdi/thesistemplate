...
\end{equation}
Die Materialparameter des Modells sind die Nullviskosität \nom[pv:eta0]{$\eta_0$}{Nullviskosität im Carreau-Yasuda Modell}, die Grenzviskosität \nom[pv:etainf]{$\eta_\infty$}{Grenzviskosität im Carreau-Yassuda Modell}, die Zeitkonstante \nom[pv:L]{$L$}{Zeitkonstante}, der Fliessindex $n$ und \nom[pv:alpha]{$\alpha$}{Parameter im Carreau-Yasuda Modell}, das den Übergang zwischen Null- und Grenzviskosität steuert.
%
...
\begin{equation}
    ...
    \label{eq:fg:bingham}
\end{equation}
Dabei ist \nom[pv:tau0]{$\tau_0$}{Fliessgrenze von viskoplastischen Materialien} die Fliessgrenze und $\mu$ die Viskosität im Newtonschen Bereich.
%
